function getValue(key, _default) {
  if (typeof process.env[key] === 'undefined') { return _default }
...
exports.init = function() {
  ...
  process.env.ASSET_BASE = getValue('ASSET_BASE', '/') // local script assets (css, other script chunks, etc) default: root /
